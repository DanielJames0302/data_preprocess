...
#     rgb = np.array(Image.open(f"{data_dir}/{frame_id}_rgb.png")).astype(np.uint8)
#     depth = np.load(f"{data_dir}/{frame_id}_depth.npy")
#     cam = np.load(f"{data_dir}/{frame_id}.npz")
#     K = cam["intrinsics"]
#     print(cam)
#     pose = cam["cam2world"]
...
# processed_unreal_4k
data_dir_unreal = "./processed_unreal/00008/1"
...
for frame_id in frame_ids:
    ...
    cam_path = f"{data_dir_unreal}/{frame_id}.npz"
